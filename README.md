...
My personal portfolio website designed to be simplistic and clean while including features like MDX blog posts with view counts, a dark mode toggle, uses list, an about page, and more.
...
Make sure you have Node.js v18.17.1 installed on your machine.
